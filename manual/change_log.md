...
- improved line handling for long or CR/LF-edited `DIR` files
- release defaults now leave debug logging off unless you turn it on

## 1.0.4.91

- added clean carrier-loss and disconnect handling
- batch moves now stop cleanly if the user drops mid-run
